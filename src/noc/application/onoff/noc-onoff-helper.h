...
namespace ns3
{
  ...
  /**
   * \brief A helper to make it easier to instantiate an ns3::NocOnOffApplication
   * on a set of nodes.
   */
  class NocOnOffHelper
  {
  public:
    /**
     * Create an NocOnOffHelper to make it easier to work with OnOffApplications
     *
     ...
     *        to.
     */
    NocOnOffHelper(std::string protocol, Address address);
