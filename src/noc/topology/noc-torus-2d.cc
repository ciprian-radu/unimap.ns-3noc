...
namespace ns3
{
  ...
  NS_OBJECT_ENSURE_REGISTERED (NocTorus2D);
  ...
  NocTorus2D::Install (NodeContainer nodes)
  {
    ...
    NS_LOG_DEBUG ("Printing the 2D torus topology (channels <-> net devices <-> nodes)...");
  ...
  void
  NocTorus2D::SaveTopology (NodeContainer nodes, string directoryPath)
  {
